...
const INITIAL_TASKS: Task[] = [
  ...
  { id: '3', title: 'Log Daily Work Progress', type: 'Manual', status: 'BACKLOG', priority: 'MEDIUM', agentId: 'kid' },
];

const COLUMNS: { id: TaskStatus; label: string; dotColor: string }[] = [
  { id: 'RECURRING', label: 'RECURRING', dotColor: 'bg-purple-500' },
  { id: 'BACKLOG', label: 'BACKLOG', dotColor: 'bg-zinc-600' },
  { id: 'IN_PROGRESS', label: 'IN_PROGRESS', dotColor: 'bg-[#00FF99]' },
  { id: 'REVIEW', label: 'REVIEW', dotColor: 'bg-yellow-500' },
];
